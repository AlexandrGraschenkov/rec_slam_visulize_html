...
- **Двойной таймлайн** - отдельные таймлайны для событий и автоматических ям
- **Настройка уверенности** - фильтрация ям по уровню уверенности
- **Клик по событиям** - перемотка видео при клике на маркер события
...
### События
- **Ямы** (красный) - обнаруженные ямы на дороге с настройкой уверенности
...
### Новые функции
- **Двойной таймлайн** - события и автоматические ямы на отдельных таймлайнах
- **Слайдер уверенности** - настройка порога для отображения ям (по умолчанию 40%)
- **Клик по событиям** - клик по маркеру на карте перематывает видео к этому времени
- **Умная фильтрация ям** - ямы с низкой уверенностью:
  - На карте: в 3 раза меньше размер, прозрачность 20%, тонкая обводка
  - На таймлайне: высота 50%, прозрачность 10%
